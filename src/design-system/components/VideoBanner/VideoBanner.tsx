...
const DefaultThumbnail: React.FC = () => (
  ...
  >
    <rect width="180" height="100" fill="var(--lightning-bluegray-800, #2e3a46)" />
    <path
      d="M90 30L120 70H60L90 30Z"
      fill="var(--lightning-orange-500, #f97316)"
      opacity="0.8"
    />
    <path
      d="M70 45L90 70H50L70 45Z"
      fill="var(--lightning-orange-400, #fb923c)"
      opacity="0.6"
    />
    <rect x="130" y="10" width="40" height="8" rx="2" fill="var(--lightning-bluegray-600, #455465)" opacity="0.5" />
  </svg>
);
