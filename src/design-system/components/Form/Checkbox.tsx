...
type CheckboxProps = {
  ...
  name?: string;
  className?: string;
  /** Custom color for the checked state (hex value) */
  color?: string;
};
...
export const Checkbox: React.FC<CheckboxProps> = ({
  ...
  // Custom color styles for checked state
  const customColorStyle = color && (checked || indeterminate) && !disabled
  ...
  return (
    <label className={containerClasses}>
      <input
        ...
        aria-invalid={error}
      />
      <span className={boxClasses} style={customColorStyle}>
