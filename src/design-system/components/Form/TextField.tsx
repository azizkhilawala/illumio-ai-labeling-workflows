  ...
  const renderStatusIcon = () => {
    ...
    return (
      <span className="ds-textfield__icon" aria-hidden="true">
        {actualType === 'validated' && <Icon name="check" size={16} />}
        {actualType === 'error' && <Icon name="circle-exclamation" size={16} />}
        {actualType === 'warning' && <Icon name="triangle-exclamation" size={16} />}
      </span>
    );
  };
