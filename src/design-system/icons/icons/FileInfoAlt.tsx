...
export const FileInfoAlt: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
...
<path d="M20 17C19.4477 17 19 17.4477 19 18V21C19 21.5523 19.4477 22 20 22C20.5523 22 21 21.5523 21 21V18C21 17.4477 20.5523 17 20 17Z" fill={color}/></>
      )}
    </svg>
  );
};
...
// Register this icon
registerIcon('file-info-alt', FileInfoAlt);
