...
export const TemperatureLow: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
  ...
  return (
    ...
    >
      ...
      {variant === 'solid' && (
        <><path fillRule="evenodd" clipRule="evenodd" d="M8 2C5.79086 2 4 3.79086 4 6V13.9995C3.37256 14.835 3 15.8748 3 16.9998C3 19.7613 5.23858 21.9998 8 21.9998C10.7614 21.9998 13 19.7613 13 16.9998C13 15.8748 12.6274 14.835 12 13.9995V6C12 3.79086 10.2091 2 8 2ZM9.00707 12.0018C9.00805 11.4495 8.56112 11.001 8.00884 11C7.45655 10.999 7.00805 11.4459 7.00707 11.9982L7.00129 15.2666C6.40278 15.6123 6 16.259 6 16.9998C6 18.1044 6.89543 18.9998 8 18.9998C9.10457 18.9998 10 18.1044 10 16.9998C10 16.2601 9.59838 15.6141 9.0013 15.2681L9.00707 12.0018Z" fill={color}/>
...
// Register this icon
registerIcon('temperature-low', TemperatureLow);
