...
export const ChevronDownDouble: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
  ...
  return (
    ...
    >
      {variant === 'linear' && (
        <><path d="M7 13L12 18L17 13M7 6L12 11L17 6" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></>
      )}
      {variant === 'solid' && (
...
// Register this icon
registerIcon('chevron-down-double', ChevronDownDouble);
