...
export const FileExclamationAlt1: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
...
<path d="M21 21C21 21.5523 20.5523 22 20 22C19.4477 22 19 21.5523 19 21C19 20.4477 19.4477 20 20 20C20.5523 20 21 20.4477 21 21Z" fill={color}/></>
      )}
    </svg>
  );
};
...
// Register this icon
registerIcon('file-exclamation-alt-1', FileExclamationAlt1);
