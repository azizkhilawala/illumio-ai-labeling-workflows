...
export const LoopVertical: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
  ...
  return (
    ...
    >
      {variant === 'linear' && (
        <><path d="M4 6L7 3M7 3L10 6M7 3V17C7 19.2091 8.79086 21 11 21M20 18L17 21M17 21L14 18M17 21V7C17 4.79086 15.2091 3 13 3" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></>
      )}
      {variant === 'solid' && (
...
// Register this icon
registerIcon('loop-vertical', LoopVertical);
