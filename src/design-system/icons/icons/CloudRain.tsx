...
export const CloudRain: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
...
<path d="M9 13C9 12.4477 8.55229 12 8 12C7.44771 12 7 12.4477 7 13V20C7 20.5523 7.44771 21 8 21C8.55229 21 9 20.5523 9 20V13Z" fill={color}/>
<path d="M16 12C16.5523 12 17 12.4477 17 13V20C17 20.5523 16.5523 21 16 21C15.4477 21 15 20.5523 15 20V13C15 12.4477 15.4477 12 16 12Z" fill={color}/>
<path d="M12 13C12.5523 13 13 13.4477 13 14V21C13 21.5523 12.5523 22 12 22C11.4477 22 11 21.5523 11 21V14C11 13.4477 11.4477 13 12 13Z" fill={color}/></>
      )}
    </svg>
  );
};
