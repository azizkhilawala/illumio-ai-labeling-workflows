...
export const CartShopping: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
...
// Register this icon
registerIcon('cart-shopping', CartShopping);
