...
export const MessageCircleLinesAlt: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
...
// Register this icon
registerIcon('message-circle-lines-alt', MessageCircleLinesAlt);
