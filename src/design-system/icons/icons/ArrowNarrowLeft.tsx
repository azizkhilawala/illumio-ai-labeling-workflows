...
export const ArrowNarrowLeft: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
...
// Register this icon
registerIcon('arrow-narrow-left', ArrowNarrowLeft);
