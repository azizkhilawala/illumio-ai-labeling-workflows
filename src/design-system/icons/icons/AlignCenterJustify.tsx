...
export const AlignCenterJustify: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
...
// Register this icon
registerIcon('align-center-justify', AlignCenterJustify);
