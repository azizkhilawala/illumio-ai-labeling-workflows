...
export const ExpandAlt: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
...
// Register this icon
registerIcon('expand-alt', ExpandAlt);
