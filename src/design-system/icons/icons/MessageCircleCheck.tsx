...
export const MessageCircleCheck: React.FC<IconComponentProps> = ({
  variant = 'linear',
  size = 24,
  color = 'currentColor',
  className = '',
  ...
  return (
    ...
    >
      ...
      {variant === 'solid' && (
        <><path fillRule="evenodd" clipRule="evenodd" d="M2.48854 19.5616C2.42003 19.7356 2.35537 19.8997 2.30007 20.05C2.23023 20.2397 2.15877 20.4291 2.08136 20.6158C1.95297 20.9244 1.98721 21.2767 2.17263 21.5548C2.3581 21.8329 2.67039 22 3.00471 22H12.0039C17.5267 22 22.0039 17.5228 22.0039 12C22.0039 6.47715 17.5267 2 12.0039 2C6.48105 2 2.00391 6.47715 2.00391 12C2.00391 13.595 2.37798 15.1053 3.04425 16.4457C3.37301 17.3161 2.87068 18.5914 2.48854 19.5616ZM15.6936 10.7203C16.0915 10.3372 16.1034 9.70418 15.7203 9.30636C15.3372 8.90854 14.7042 8.89659 14.3064 9.27968L10.8462 12.6117L9.69364 11.5019C9.29582 11.1188 8.66277 11.1308 8.27968 11.5286C7.89659 11.9264 7.90854 12.5595 8.30636 12.9425L10.1525 14.7203C10.5398 15.0932 11.1525 15.0932 11.5398 14.7203L15.6936 10.7203Z" fill={color}/></>
      )}
    </svg>
  );
};
